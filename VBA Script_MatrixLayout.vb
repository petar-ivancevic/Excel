...
Private Sub GenerateOneAuditorWorkbook(ByVal auditorID As String, _
    ...
    wbNew.SaveAs Filename:=outPath, FileFormat:=xlOpenXMLWorkbookMacroEnabled
...
Private Sub BuildJurisdictionSheet(ByVal ws As Worksheet, ByVal wsLists As Worksheet, _
    ...
    ' --- ORIGINAL LOGIC CONTINUES BELOW (UNCHANGED) ---
    ' (This file is long; everything below is your original VBA, unchanged,
    '  except the ByVal->ByRef fixes already applied where needed.)
...
'=============================
' The remainder of your original module follows unchanged
'=============================
...
Private Function GetNamedRangeValue(ByVal wb As Workbook, ByVal rangeName As String) As Variant
    On Error GoTo ErrHandler
    GetNamedRangeValue = wb.Names(rangeName).RefersToRange.Value
    Exit Function
ErrHandler:
...
Private Function BuildOutputPath(ByVal outFolder As String, ByVal batchID As String, ByVal auditorID As String) As String
    BuildOutputPath = EnsureTrailingSlash(outFolder) & "KYC_Workpapers_" & CleanFilePart(batchID) & "_" & CleanFilePart(auditorID) & ".xlsm"
End Function
